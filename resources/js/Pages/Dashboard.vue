                        ...
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                ...
                                <div class="text-gray-300 space-y-3">
                                    ...
                                    <div v-if="selectedWorkOrder.customer_id || selectedWorkOrder.customer_name"
                                        class="mt-4">
                                    ...
                                    <div v-if="selectedWorkOrder.created_at || selectedWorkOrder.date">
                                        ...
                                        <p>{{ new Date(selectedWorkOrder.created_at ||
                                            selectedWorkOrder.date).toLocaleString() }}</p>
                                    </div>
                                    ...
                                    <template v-for="(value, key) in selectedWorkOrder" :key="key">
                                        <div
                                            ...
                                            <p class="text-sm text-gray-400">{{ key.charAt(0).toUpperCase() +
                                                key.slice(1).replace('_', ' ') }}:</p>
                                            <p>{{ value }}</p>
                                        </div>
                                    </template>
                                </div>

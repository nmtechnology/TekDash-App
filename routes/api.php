...
Route::get('/work-orders/{id}/tasks', [WorkOrderController::class, 'getTasks']);
Route::post('/work-orders/{id}/tasks', [WorkOrderController::class, 'addTask']);
Route::delete('/work-orders/{id}/tasks/{taskId}', [WorkOrderController::class, 'deleteTask']);
Route::get('/work-orders/{id}/appointments', [WorkOrderController::class, 'getAppointments']);
Route::post('/work-orders/{id}/appointments', [WorkOrderController::class, 'addAppointment']);
Route::delete('/work-orders/{id}/appointments/{appointmentId}', [WorkOrderController::class, 'deleteAppointment']);
Route::get('/work-orders/{id}/meetings', [WorkOrderController::class, 'getMeetings']);
Route::post('/work-orders/{id}/meetings', [WorkOrderController::class, 'addMeeting']);
Route::delete('/work-orders/{id}/meetings/{meetingId}', [WorkOrderController::class, 'deleteMeeting']);
Route::get('/work-orders/{id}/reminders', [WorkOrderController::class, 'getReminders']);
Route::post('/work-orders/{id}/reminders', [WorkOrderController::class, 'addReminder']);
Route::delete('/work-orders/{id}/reminders/{reminderId}', [WorkOrderController::class, 'deleteReminder']);
Route::get('/work-orders/{id}/attendees', [WorkOrderController::class, 'getAttendees']);
Route::post('/work-orders/{id}/attendees', [WorkOrderController::class, 'addAttendee']);
Route::delete('/work-orders/{id}/attendees/{attendeeId}', [WorkOrderController::class, 'deleteAttendee']);
Route::get('/work-orders/{id}/attachments', [WorkOrderController::class, 'getAttachments']);
Route::post('/work-orders/{id}/attachments', [WorkOrderController::class, 'addAttachment']);
Route::delete('/work-orders/{id}/attachments/{attachmentId}', [WorkOrderController::class, 'deleteAttachment']);
Route::get('/work-orders/{id}/attendee-attachments', [WorkOrderController::class, 'getAttendeeAttachments']);
Route::post('/work-orders/{id}/attendee-attachments', [WorkOrderController::class, 'addAttendeeAttachment']);
Route::delete('/work-orders/{id}/attendee-attachments/{attendeeAttachmentId}', [WorkOrderController::class, 'deleteAttendeeAttachment']);
Route::get('/work-orders/{id}/attachment-attendees', [WorkOrderController::class, 'getAttachmentAttendees']);
Route::post('/work-orders/{id}/attachment-attendees', [WorkOrderController::class, 'addAttachmentAttendee']);
Route::delete('/work-orders/{id}/attachment-attendees/{attachmentAttendeeId}', [WorkOrderController::class, 'deleteAttachmentAttendee']);       
Route::get('/work-orders/{id}/attendee-attachment-attendees', [WorkOrderController::class, 'getAttendeeAttachmentAttendees']);
Route::post('/work-orders/{id}/attendee-attachment-attendees', [WorkOrderController::class, 'addAttendeeAttachmentAttendee']);
Route::delete('/work-orders/{id}/attendee-attachment-attendees/{attendeeAttachmentAttendeeId}', [WorkOrderController::class, 'deleteAttendeeAttachmentAttendee']);
Route::get('/work-orders/{id}/attachment-attendee-attachments', [WorkOrderController::class, 'getAttachmentAttendeeAttachments']);
Route::post('/work-orders/{id}/attachment-attendee-attachments', [WorkOrderController::class, 'addAttachmentAttendeeAttachment']);
Route::delete('/work-orders/{id}/attachment-attendee-attachments/{attachmentAttendeeAttachmentId}', [WorkOrderController::class, 'deleteAttachmentAttendeeAttachment']);
Route::get('/work-orders/{id}/attendee-attachment-attendee-attachments', [WorkOrderController::class, 'getAttendeeAttachmentAttendeeAttachments']);
Route::post('/work-orders/{id}/attendee-attachment-attendee-attachments', [WorkOrderController::class, 'addAttendeeAttachmentAttendeeAttachment']);
...
Route::get('/work-orders/{id}/attachment-attendee-attachment-attendees', [WorkOrderController::class, 'getAttachmentAttendeeAttachmentAttendees']);
Route::post('/work-orders/{id}/attachment-attendee-attachment-attendees', [WorkOrderController::class, 'addAttachmentAttendeeAttachmentAttendee']);
Route::delete('/work-orders/{id}/attachment-attendee-attachment-attendees/{attachmentAttendeeAttachmentAttendeeId}', [WorkOrderController::class, 'deleteAttachmentAttendeeAttachmentAttendee']);
Route::get('/work-orders/{id}/attendee-attachment-attendee-attachments', [WorkOrderController::class, 'getAttendeeAttachmentAttendeeAttachments']);
Route::post('/work-orders/{id}/attendee-attachment-attendee-attachments', [WorkOrderController::class, 'addAttendeeAttachmentAttendeeAttachment']);
Route::delete('/work-orders/{id}/attendee-attachment-attendee-attachments/{attendeeAttachmentAttendeeAttachmentId}', [WorkOrderController::class, 'deleteAttendeeAttachmentAttendeeAttachment']);
Route::get('/work-orders/{id}/attachment-attendee-attachment-attendees', [WorkOrderController::class, 'getAttachmentAttendeeAttachmentAttendees']);

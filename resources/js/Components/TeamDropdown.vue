    ...
    <Dropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.auth.user.current_team" align="right" width="60">
        <template #trigger>
            <span class="inline-flex rounded-md">
                <button type="button" class="inline-flex btn items-center px-3 py-2 font-bold border border-transparent text-sm leading-4 rounded-md text-gray-900 dark:text-lime-400 hover:bg-gray-900 dark:hover:bg-gray-900 focus:outline-none transition ease-in-out duration-150">

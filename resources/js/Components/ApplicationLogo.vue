...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-900 relative isolate overflow-hidden">
            <nav class="fixed top-0 left-0 right-0 bg-transparent backdrop-blur-md border-b border-gray-100 z-50">

<template>
    <div class="min-h-screen flex flex-col items-center justify-center relative isolate overflow-hidden pt-14">
        <div class="mb-8">
            <slot name="logo" />
        </div>
        
        <div class="w-full sm:max-w-md px-6 py-6 bg-gray-900 shadow-md overflow-hidden sm:rounded-lg">
            <slot />
        </div>

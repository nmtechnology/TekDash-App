...
<template>
  <AppLayout>
    <template #header>
      <div class="fixed mt-[80px] top-0 left-0 right-0 z-10 backdrop-blur-md bg-white/50 dark:bg-gray-800/60 glass-header">
        <div
          class="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-900 dark:text-lime-400 leading-tight">
              Dashboard
              <CurrentTime />
            </h2>
    ...
    <div class="py-12 mt-[100px]">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white/70 dark:bg-gray-900/70 overflow-hidden shadow-xl sm:rounded-lg p-6">
          ...
          <div class="pt-16">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              ...
              <div v-if="isLoading" class="flex justify-center items-center py-12">
                <div
                  class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-indigo-500 dark:border-lime-400">
                </div>
              </div>
              <!-- Stats component -->
              <div v-else>
              ...
              <div
                class="relative bg-transparent opacity-75 overflow-hidden shadow-xl sm:rounded-lg bg-cover bg-center bg-no-repeat"
          ...
          <div
                ...
                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                  ...
                  <div class="text-gray-300 space-y-3">
                    ...
                    <div v-if="selectedWorkOrder.customer_id || selectedWorkOrder.customer_name" class="mt-4">
                      ...
                      <p v-if="selectedWorkOrder.customer_name">{{ selectedWorkOrder.customer_name }}
                      </p>
                      <p v-if="selectedWorkOrder.customer_id" class="text-sm">ID: {{
                    ...
                    <template v-for="(value, key) in selectedWorkOrder" :key="key">
                      <div
                        ...
                        <p class="text-sm text-gray-400">{{ key.charAt(0).toUpperCase() + key.slice(1).replace('_', ' ')
                          }}:</p>
                        <p>{{ value }}</p>
                      </div>
                    </template>
            ...
            <div class="bg-gray-800 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              ...
              <button @click="closeModal" type="button"
                class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-700 shadow-sm px-4 py-2 bg-gray-700 text-base font-medium text-gray-300 hover:bg-gray-600 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                Close
              </button>
            </div>
          </div>
